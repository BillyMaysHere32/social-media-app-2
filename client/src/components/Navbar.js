...
//             <Nav expand="lg" className="me-auto fs-4">
...
export function Navbar() {
  ...
  return (
    <NavbarBoot collapseOnSelect expand="true" className="bg-white shadow-sm mb-3">
        <Container>
            <NavbarBoot.Brand className="d-flex flex-row align-items-center">
                <div className="d-flex flex-column align-items-center">
                    {/* <img 
                        className=''
                        style={{ width: "150px", height: "50px", objectFit: "cover" }}
